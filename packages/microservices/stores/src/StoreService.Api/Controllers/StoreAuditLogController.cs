...
// field-level change to every stock/catalog row, wider than any store-specific read permission.
[Authorize(Policy = "system.admin")]
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/stores-audit-log")]
public class StoreAuditLogController(StoreDbContext db) : ControllerBase
{
    [HttpGet]
        ...
        [FromQuery] int page = 1, [FromQuery] int pageSize = 50)
    {
        ...
        var query = db.StoreAuditLogs.AsQueryable();
