...
/// <summary>Design-time factory for <see cref="TenantStoreDbContext"/>. Emits schema-agnostic
/// migrations that apply into whichever tenant schema the connection's search_path points at.</summary>
public class TenantStoreDbContextDesignTimeFactory : IDesignTimeDbContextFactory<TenantStoreDbContext>
{
