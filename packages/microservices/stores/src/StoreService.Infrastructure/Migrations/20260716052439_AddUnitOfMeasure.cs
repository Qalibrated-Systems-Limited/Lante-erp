...
namespace StoreService.Infrastructure.Migrations
{
    ...
    public partial class AddUnitOfMeasure : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Backfill: turn each distinct existing free-text Uom value (e.g. "kg", "pcs") into a
            // real units_of_measure row, then repoint item_masters at it, before dropping the old
            // column — a raw string value would otherwise violate the FK constraint added below.
