...
// The ONE repository implementation for every Reporting-owned entity — registered as an
// open generic in InfrastructureServiceRegistration.
public class GenericRepository<T>(ReportingDbContext context) : IGenericRepository<T>
    where T : BaseEntity
{
    protected readonly ReportingDbContext Context = context;
