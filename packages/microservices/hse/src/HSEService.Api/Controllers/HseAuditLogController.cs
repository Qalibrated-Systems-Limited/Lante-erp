...
// field-level change to every HSE row, wider than any hse-specific read permission.
[Authorize(Policy = "system.admin")]
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/hse-audit-log")]
public class HseAuditLogController(HSEDbContext db) : ControllerBase
{
    [HttpGet]
        ...
        [FromQuery] int page = 1, [FromQuery] int pageSize = 50)
    {
        ...
        var query = db.HseAuditLogs.AsQueryable();
