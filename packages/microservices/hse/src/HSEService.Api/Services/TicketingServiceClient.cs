...
namespace HSEService.Api.Services;
...
{
    public async Task CreateAlertAsync(string tenantSchema, string source, string severity, string title, string message, string? assignedToUserId = null, string? requiredPermission = null)
    {
        ...
        try
        {
            ...
            var payload = new { source, severity, title, message, assignedToUserId, requiredPermission };
