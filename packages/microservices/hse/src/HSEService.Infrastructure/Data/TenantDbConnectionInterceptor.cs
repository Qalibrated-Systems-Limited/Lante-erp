...
/// user identity). Copied verbatim (namespace only) from TicketingService — see that copy for the
/// full rationale on claim-wins-over-header and always-set-search_path.
/// </summary>
