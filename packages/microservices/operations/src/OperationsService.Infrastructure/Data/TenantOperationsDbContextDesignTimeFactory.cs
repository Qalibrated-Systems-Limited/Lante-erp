...
/// <summary>
/// Design-time factory for <see cref="TenantOperationsDbContext"/>. Emits schema-agnostic migrations
/// that apply into whichever tenant schema the connection's search_path points at.
/// </summary>
public class TenantOperationsDbContextDesignTimeFactory : IDesignTimeDbContextFactory<TenantOperationsDbContext>
{
    private const string ApiProject = "OperationsService.Api";

    public TenantOperationsDbContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseNpgsql(connectionString, o => o.MigrationsAssembly("OperationsService.Infrastructure"));
