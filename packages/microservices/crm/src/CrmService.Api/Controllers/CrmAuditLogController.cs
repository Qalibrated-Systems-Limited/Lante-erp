...
// field-level change to every customer/deal row, wider than any crm-specific read permission.
[Authorize(Policy = "system.admin")]
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/crm-audit-log")]
public class CrmAuditLogController(CrmDbContext db) : ControllerBase
{
    [HttpGet]
        ...
        [FromQuery] int page = 1, [FromQuery] int pageSize = 50)
    {
        ...
        var query = db.CrmAuditLogs.AsQueryable();
