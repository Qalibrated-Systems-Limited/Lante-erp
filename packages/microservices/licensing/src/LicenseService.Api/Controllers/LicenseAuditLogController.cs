...
// field-level change to every license row, wider than any licensing-specific read permission.
[Authorize(Policy = "system.admin")]
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/licensing-audit-log")]
public class LicenseAuditLogController(LanteLicenseDbContext db) : ControllerBase
{
    [HttpGet]
        ...
        [FromQuery] int page = 1, [FromQuery] int pageSize = 50)
    {
        ...
        var query = db.LicenseAuditLogs.AsQueryable();
        ...
        return Ok(new ApiResponse<object> { Success = true, Data = new { items, totalCount, page, pageSize } });
    }
}
