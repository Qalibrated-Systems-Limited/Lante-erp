...
/// <summary>
/// Design-time factory for <see cref="TenantComplianceDbContext"/>. The model is schema-agnostic,
...
/// </summary>
public class TenantComplianceDbContextDesignTimeFactory : IDesignTimeDbContextFactory<TenantComplianceDbContext>
{
    private const string ApiProject = "ComplianceService.Api";

    public TenantComplianceDbContext CreateDbContext(string[] args)
    {
        ...
        var optionsBuilder = new DbContextOptionsBuilder<TenantComplianceDbContext>();
        optionsBuilder.UseNpgsql(connectionString, o => o.MigrationsAssembly("ComplianceService.Infrastructure"));

        return new TenantComplianceDbContext(optionsBuilder.Options);
    }
}
