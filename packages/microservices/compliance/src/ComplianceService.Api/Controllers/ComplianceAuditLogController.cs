...
// field-level change to every compliance row, wider than any compliance-specific read permission.
[Authorize(Policy = "system.admin")]
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/compliance-audit-log")]
public class ComplianceAuditLogController(ComplianceDbContext db) : ControllerBase
{
    [HttpGet]
        ...
        [FromQuery] int page = 1, [FromQuery] int pageSize = 50)
    {
        ...
        var query = db.ComplianceAuditLogs.AsQueryable();
