...
/// <summary>
/// Design-time factory for <see cref="TenantSubcontractsDbContext"/>. The model is schema-agnostic,
...
/// </summary>
public class TenantSubcontractsDbContextDesignTimeFactory : IDesignTimeDbContextFactory<TenantSubcontractsDbContext>
{
    private const string ApiProject = "SubcontractsService.Api";

    public TenantSubcontractsDbContext CreateDbContext(string[] args)
    {
        ...
        var optionsBuilder = new DbContextOptionsBuilder<TenantSubcontractsDbContext>();
        optionsBuilder.UseNpgsql(connectionString, o => o.MigrationsAssembly("SubcontractsService.Infrastructure"));

        return new TenantSubcontractsDbContext(optionsBuilder.Options);
    }
}
