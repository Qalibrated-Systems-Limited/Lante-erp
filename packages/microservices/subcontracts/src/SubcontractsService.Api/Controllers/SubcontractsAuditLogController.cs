...
// field-level change to every subcontract row, wider than any subcontracts-specific read permission.
[Authorize(Policy = "system.admin")]
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/subcontracts-audit-log")]
public class SubcontractsAuditLogController(SubcontractsDbContext db) : ControllerBase
{
    [HttpGet]
        ...
        [FromQuery] int page = 1, [FromQuery] int pageSize = 50)
    {
        ...
        var query = db.SubcontractsAuditLogs.AsQueryable();
